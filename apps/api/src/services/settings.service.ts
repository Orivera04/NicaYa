...
const defaults: Record<string,string>={launchPhase:"1",baseFare:"50",pricePerKm:"15",minimumFare:"50",currency:"NIO",monthlySubscriptionPrice:"200",freePlanCommissionPercent:"0",premiumPlanCommissionPercent:"5",standardPlanCommissionPercent:"15"};
