...
export default function ClientPage() {
  ...
  return <Guard roles={["CLIENT"]}><MobileAppShell role="CLIENT"><div className="trip-flow pb-4">
    ...
    {stage === "TRACKING" && activeTrip?.status === "IN_PROGRESS" && <button className="trip-in-progress-cancel" disabled={busy} onClick={() => setShowCancel(true)}>Cancelar viaje por incidencia</button>}
