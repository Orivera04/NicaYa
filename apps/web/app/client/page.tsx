...
export default function ClientPage() {
  ...
  useEffect(() => { loadFavorites(); try { const data = localStorage.getItem(recentStorageKey); if (data) setRecents(JSON.parse(data)); } catch {} locate(); }, []);
  ...
  return <Guard roles={["CLIENT"]}><main className="mx-auto max-w-md p-4">
    ...
    <section className="mt-3 space-y-3"><section id="servicio" className="card"><b>Servicio disponible: Moto</b><p className="muted mt-1">Traslado individual en motocicleta. Capacidad: 1 pasajero. Usa casco y sigue las reglas de seguridad.</p></section>
