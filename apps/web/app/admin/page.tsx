...
const cards: { key: keyof Dashboard; label: string; caption: string; href: string; tone: string }[] = [
  ...
  { key: "pendingPayments", label: "Suscripciones pendientes", caption: "Comprobantes por validar", href: "/admin/payment-reviews", tone: "from-violet-500/20 to-indigo-500/5" },
