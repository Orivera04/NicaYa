...
function NavIcon({ name }: { name: string }) {
  const paths: Record<string, string> = { IN: "M3 10.5 12 3l9 7.5v9a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z", GO: "M5 17h14l-2-5H7zM8 12l2-5h4l2 5M7 20h.01M17 20h.01", LU: "M12 21s7-5.4 7-12a7 7 0 1 0-14 0c0 6.6 7 12 7 12zm0-9a3 3 0 1 1 0-6 3 3 0 0 1 0 6z", HI: "M12 8v5l3 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z", CU: "M20 21a8 8 0 0 0-16 0M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8z", OK: "m5 12 4 4L19 6", RI: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8m13 10v-2a4 4 0 0 1 0 7.8", PA: "M3 7h18v10H3zM3 10h18M7 16h3", PL: "M4 5h16v14H4zM7 9h10M7 13h6", VI: "M4 5h16v14H4zM8 9h8M8 13h5", AD: "M4 19V5l14 7zM18 12h2a2 2 0 0 1 0 4h-2", CF: "M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-1.95 1.95-.06-.06A1.7 1.7 0 0 0 15.9 18.5l-.1.04v2.76h-2.76l-.04-.1a1.7 1.7 0 0 0-1.88-.34l-.06.06-1.95-1.95.06-.06A1.7 1.7 0 0 0 8.5 17l-.04-.1H5.7v-2.76l.1-.04a1.7 1.7 0 0 0 .34-1.88l-.06-.06 1.95-1.95.06.06A1.7 1.7 0 0 0 10 9.5l.1-.04V6.7h2.76l.04.1a1.7 1.7 0 0 0 1.88.34l.06-.06 1.95 1.95-.06.06A1.7 1.7 0 0 0 15.5 11l.04.1h2.76v2.76z" };
